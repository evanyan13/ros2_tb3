...
from .global_planner_package.global_map import GlobalMap
from .global_planner_package.global_planner_node import GlobalPlannerNode
from .global_planner_package.astar_path_finder import find_astar_path
from .global_planner_package.global_mover import GlobalMover
from .global_planner_package.utils import euler_from_quaternion


class GlobalPlannerMain(Node):
    states = ['IDLE', 'PLANNING', 'NAVIGATING']
    
    def __init__(self):
        super().__init__('global_planner_main')
    ...
    def initialise_state(self):
        self.machine = Machine(model=self, states=GlobalPlannerMain.states, initial='IDLE')
